...
export const itemsStudent: MenuItems = [
  ...
  { id: 7, link: "/student/lessons", label: "درس‌ها", icon: MdHomeWork },
  {
    id: 8,
  ...
  { id: 9, link: "/student/tests", label: "تمرین‌های تستی", icon: MdQuiz },
  { id: 10, link: "/student/profile", label: "پروفایل", icon: BsPersonCircle },
];
